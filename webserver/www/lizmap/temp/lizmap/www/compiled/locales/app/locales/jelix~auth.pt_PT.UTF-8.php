<?php $_loaded= array (
  ...
  'error.lds.request.not.send' => '(605)Erro ao tentar enviar pedido ao servidor LDS',
  'error.lds.unreachable.server' => '(606)Impossível estabelecer ligação com o servidor LDS',
  ...
  'ldap.extension.unloaded' => '(612)Extensão LDAP não carregada',
  'ldap.object.user.unknown' => '(613)objeto do utilizador desconhecido',
  'ldap.user.login.unset' => '(614)identificação do utilizador não estabelecida',
