<?php $_loaded= array (
  ...
  'config.services.allowUserAccountRequest.noemail' => 'This option cannot be enable while the sender email is not defined. Please contact the application administrator.',
  ...
  'upload.image.error.file.save' => 'An error occured during the save',
) ?>