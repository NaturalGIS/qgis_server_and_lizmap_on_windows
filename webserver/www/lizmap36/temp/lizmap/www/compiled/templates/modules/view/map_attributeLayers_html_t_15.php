...
filemtime('C:\webserver\www\lizmap36\lizmap\modules\view\templates/map_attributeLayers.tpl') > 1616160726){ return false;
} else {
...
?><div class="tabbable">
  <div class="tab-content" id="attribute-table-container">
    ...
    <div class="tab-pane active attribute-content bottom-content" id="attribute-summary" >
      ...
      <?php  $formTplController = new \jelix\forms\HtmlWidget\TemplateController($t->_vars['form'], 'htmlbootstrap',array(), 'view~default:index', array());$formTplController->startForm();$formTplController->outputAllControls();$formTplController->endForm();?>
