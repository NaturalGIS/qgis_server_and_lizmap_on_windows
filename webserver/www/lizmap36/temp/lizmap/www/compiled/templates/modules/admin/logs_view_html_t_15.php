...
filemtime('C:\webserver\www\lizmap36\lizmap\modules\admin\templates/logs_view.tpl') > 1696349194){ return false;
} else {
...
?><?php jtpl_function_html_jmessage_bootstrap( $t);?>
  ...
  <div>
    ...
    <div class="form-actions">
      ...
      <?php  if(jAcl2::check('lizmap.admin.lizmap.log.delete')):?>
