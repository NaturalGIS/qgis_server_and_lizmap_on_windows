...
filemtime('C:\webserver\www\lizmap36\lizmap/app/themes/default/master_admin/zone_dashboard.tpl') > 1696349194){ return false;
} else {
...
<div id="dashboard-content" class="row">
    <div id="dashboard-left-column" class="span6">
        ...
        <div class="dashboard-widget well">
            <h3><?php echo htmlspecialchars($t->_vars['widgets'][$t->_vars['i']]->title, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8"); ?></h3>
