...
filemtime('C:\webserver\www\lizmap36\lizmap\modules\lizmap\templates/wmts_capabilities.tpl') > 1674574447){ return false;
} else {
 require_once('C:\webserver\www\lizmap36\lizmap\vendor\jelix\castor\lib\plugins/common/modifier.number_format.php');
function template_meta_aadb17b3dce2b10569e8267755931785($t){

}
function template_aadb17b3dce2b10569e8267755931785($t){
...
<Capabilities version="1.0.0" xmlns="http://www.opengis.net/wmts/1.0"
    ...
    <ows:OperationsMetadata>
        <ows:Operation name="GetCapabilities">
            <ows:DCP>
                <ows:HTTP>
                    <ows:Get xlink:href="<?php echo htmlspecialchars($t->_vars['url'], ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8"); ?>">
