...
filemtime('C:\webserver\www\lizmap36\lizmap\modules\view\templates/view.tpl') > 1673621956){ return false;
} else {
    ...
    <div class="thumbnail">
      <div class="liz-project">
        ...
        <p class="liz-project-desc" style="display:none;">
          ...
          <br/>
          <br/><b><?php echo jLocale::get('default.project.abstract.label'); ?></b>&nbsp;: <span class="abstract"><?php echo jtpl_modifier2_common_truncate($t, strip_tags($t->_vars['p']->abstract),100); ?></span>
          <br/>
