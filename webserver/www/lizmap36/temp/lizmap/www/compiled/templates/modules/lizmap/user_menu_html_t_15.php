...
filemtime('C:\webserver\www\lizmap36\lizmap\modules\lizmap\templates/user_menu.tpl') > 1620802989){ return false;
} else {
    ...
    <li class="user dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="info-user">
            ...
            <span class="text hidden-phone">
                <span id="info-user-login" title="<?php echo $t->_vars['user']->firstname; ?> <?php echo $t->_vars['user']->lastname; ?>"><?php echo htmlspecialchars($t->_vars['user']->login, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8"); ?></span>
