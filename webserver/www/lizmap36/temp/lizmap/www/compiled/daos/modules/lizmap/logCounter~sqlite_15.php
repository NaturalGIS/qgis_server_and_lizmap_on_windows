...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('C:\webserver\www\lizmap36\lizmap\modules\lizmap\daos/logCounter.dao.xml') > 1616160726)){ return false;
}
else {
 require_once ( JELIX_LIB_PATH .'dao/jDaoRecordBase.class.php');
 require_once ( JELIX_LIB_PATH .'dao/jDaoFactoryBase.class.php');

class cDaoRecord_lizmap_Jx_logCounter_Jx_sqlite extends jDaoRecordBase {
 public $id;
 public $key;
 public $counter;
 public $repository;
 public $project;
   ...
   public function getProperties() { return cDao_lizmap_Jx_logCounter_Jx_sqlite::$_properties; }
   public function getPrimaryKeyNames() { return cDao_lizmap_Jx_logCounter_Jx_sqlite::$_pkFields; }
}

class cDao_lizmap_Jx_logCounter_Jx_sqlite extends jDaoFactoryBase {
  ...
  array (
   ...
   protected $_DaoRecordClassName='cDaoRecord_lizmap_Jx_logCounter_Jx_sqlite';
