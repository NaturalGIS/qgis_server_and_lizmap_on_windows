...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('C:\webserver\www\lizmap36\lizmap\modules\lizmap\daos/user.dao.xml') > 1696349194)){ return false;
}
else {
 require_once ( JELIX_LIB_PATH .'dao/jDaoRecordBase.class.php');
 require_once ( JELIX_LIB_PATH .'dao/jDaoFactoryBase.class.php');

class cDaoRecord_lizmap_Jx_user_Jx_sqlite extends jDaoRecordBase {
 public $login;
 public $email;
 public $password;
 public $firstname;
 ...
 public $create_date;
   ...
   public function getProperties() { return cDao_lizmap_Jx_user_Jx_sqlite::$_properties; }
   public function getPrimaryKeyNames() { return cDao_lizmap_Jx_user_Jx_sqlite::$_pkFields; }
}

class cDao_lizmap_Jx_user_Jx_sqlite extends jDaoFactoryBase {
  ...
  array (
   ...
   protected $_DaoRecordClassName='cDaoRecord_lizmap_Jx_user_Jx_sqlite';
...
$__query .=' WHERE  usr.usr_login '.' = '.$this->_conn->quote($login).'';
 ...
 function getByLoginOrEmail ($login){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE ( usr.usr_login '.' = '.$this->_conn->quote($login).' OR usr.usr_email '.' = '.$this->_conn->quote($login).')';
    $__rs = $this->_conn->limitQuery($__query,0,1);
    $this->finishInitResultSet($__rs);
    return $__rs->fetch();
}
 function getByEmail ($email){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE  usr.usr_email '.' = '.$this->_conn->quote($email).'';
