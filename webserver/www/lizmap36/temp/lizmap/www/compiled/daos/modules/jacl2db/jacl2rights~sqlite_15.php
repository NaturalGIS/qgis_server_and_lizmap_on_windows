...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('C:\webserver\www\lizmap36\lizmap\vendor\jelix\jelix\lib\jelix-modules\jacl2db\daos/jacl2rights.dao.xml') > 1696258090)){ return false;
}
else {
 require_once ( JELIX_LIB_PATH .'dao/jDaoRecordBase.class.php');
 require_once ( JELIX_LIB_PATH .'dao/jDaoFactoryBase.class.php');

class cDaoRecord_jacl2db_Jx_jacl2rights_Jx_sqlite extends jDaoRecordBase {
 public $id_aclsbj;
 public $id_aclgrp;
 public $id_aclres;
 public $canceled=0;
   public function getSelector() { return "jacl2db~jacl2rights"; }
   public function getProperties() { return cDao_jacl2db_Jx_jacl2rights_Jx_sqlite::$_properties; }
   public function getPrimaryKeyNames() { return cDao_jacl2db_Jx_jacl2rights_Jx_sqlite::$_pkFields; }
}

class cDao_jacl2db_Jx_jacl2rights_Jx_sqlite extends jDaoFactoryBase {
  ...
  array (
   ...
   protected $_DaoRecordClassName='cDaoRecord_jacl2db_Jx_jacl2rights_Jx_sqlite';
...
';
 ...
 function getRight ($right, $groups){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE  r.id_aclsbj '.' = '.$this->_conn->quote($right).' AND r.id_aclres = \'-\' AND r.id_aclgrp IN ('.implode(',', array_map( array($this, '_callbackQuote'), is_array($groups)?$groups:array($groups))).')';
...
$__query .=' WHERE  r.id_aclres = \'-\' AND r.id_aclgrp '.' = '.$this->_conn->quote($group).'';
 ...
 function getResByRightByGroup ($group, $right){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE  r.id_aclsbj '.' = '.$this->_conn->quote($right).' AND r.id_aclgrp '.' = '.$this->_conn->quote($group).' AND r.id_aclres <> \'-\'';
    $__rs = $this->_conn->query($__query);
    $this->finishInitResultSet($__rs);
    return $__rs;
}
 function getRightWithRes ($right, $groups, $res){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE  r.id_aclsbj '.' = '.$this->_conn->quote($right).' AND r.id_aclres '.' = '.$this->_conn->quote($res).' AND r.id_aclgrp IN ('.implode(',', array_map( array($this, '_callbackQuote'), is_array($groups)?$groups:array($groups))).') ORDER BY r.canceled desc';
    $__rs = $this->_conn->limitQuery($__query,0,1);
    $this->finishInitResultSet($__rs);
    return $__rs->fetch();
}
...
$__query .=' WHERE  r.id_aclres <> \'-\' AND r.id_aclgrp '.' = '.$this->_conn->quote($group).' ORDER BY r.id_aclsbj asc';
 ...
 function getRightsByRole ($right){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE  r.id_aclsbj '.' = '.$this->_conn->quote($right).'';
    $__rs = $this->_conn->query($__query);
    $this->finishInitResultSet($__rs);
    return $__rs;
}
 function getRightSettings ($right){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE  r.id_aclsbj '.' = '.$this->_conn->quote($right).'';
    $__rs = $this->_conn->query($__query);
    $this->finishInitResultSet($__rs);
 ...
 function getAnonymousRight ($right){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE  r.id_aclsbj '.' = '.$this->_conn->quote($right).' AND r.id_aclres = \'-\' AND r.id_aclgrp = \'__anonymous\'';
    $__rs = $this->_conn->limitQuery($__query,0,1);
    $this->finishInitResultSet($__rs);
    return $__rs->fetch();
}
 function getAnonymousRightWithRes ($right, $res){
    $__query =  $this->_selectClause.$this->_fromClause.$this->_whereClause;
$__query .=' WHERE  r.id_aclsbj '.' = '.$this->_conn->quote($right).' AND r.id_aclres '.' = '.$this->_conn->quote($res).' AND r.id_aclgrp = \'__anonymous\'';
    $__rs = $this->_conn->limitQuery($__query,0,1);
    $this->finishInitResultSet($__rs);
    return $__rs->fetch();
}
...
$__query .=' WHERE  id_aclgrp '.' = '.$this->_conn->quote($group).'';
 ...
 function deleteByRightRes ($right, $res){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclsbj '.' = '.$this->_conn->quote($right).' AND id_aclres '.' = '.$this->_conn->quote($res).'';
    return $this->_conn->exec ($__query);
}
 function deleteByRight ($right){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclsbj '.' = '.$this->_conn->quote($right).'';
    return $this->_conn->exec ($__query);
}
 function deleteByRoleRes ($right, $res){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclsbj '.' = '.$this->_conn->quote($right).' AND id_aclres '.' = '.$this->_conn->quote($res).'';
    return $this->_conn->exec ($__query);
}
 function deleteByRole ($right){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclsbj '.' = '.$this->_conn->quote($right).'';
    return $this->_conn->exec ($__query);
}
 function deleteBySubjRes ($right, $res){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclsbj '.' = '.$this->_conn->quote($right).' AND id_aclres '.' = '.$this->_conn->quote($res).'';
    return $this->_conn->exec ($__query);
}
 function deleteBySubject ($right){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclsbj '.' = '.$this->_conn->quote($right).'';
    return $this->_conn->exec ($__query);
}
...
$__query .=' WHERE  id_aclgrp '.' = '.$this->_conn->quote($group).' AND id_aclsbj IN ('.implode(',', array_map( array($this, '_callbackQuote'), is_array($subjects)?$subjects:array($subjects))).') AND id_aclres = \'-\'';
 ...
 function deleteByGroupAndRoles ($group, $rights){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclgrp '.' = '.$this->_conn->quote($group).' AND id_aclsbj IN ('.implode(',', array_map( array($this, '_callbackQuote'), is_array($rights)?$rights:array($rights))).') AND id_aclres = \'-\'';
    return $this->_conn->exec ($__query);
}
 function deleteByGroupAndRights ($group, $rights){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclgrp '.' = '.$this->_conn->quote($group).' AND id_aclsbj IN ('.implode(',', array_map( array($this, '_callbackQuote'), is_array($rights)?$rights:array($rights))).') AND id_aclres = \'-\'';
    return $this->_conn->exec ($__query);
}
 function deleteRightsOnResource ($group, $rights){
    $__query = 'DELETE FROM '.$this->_conn->prefixTable('jacl2_rights').' ';
$__query .=' WHERE  id_aclgrp '.' = '.$this->_conn->quote($group).' AND id_aclsbj IN ('.implode(',', array_map( array($this, '_callbackQuote'), is_array($rights)?$rights:array($rights))).') AND id_aclres <> \'-\'';
    return $this->_conn->exec ($__query);
}
